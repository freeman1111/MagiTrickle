...
доступа*, поле `description` в RCI), либо системное имя вида `Policy4`. Метки запрашиваются при старте сервиса: если политика не найдена или RCI недоступен, в лог
